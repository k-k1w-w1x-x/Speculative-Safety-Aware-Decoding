...
base_cmd = "CUDA_VISIBLE_DEVICES=2 python defense.py --model_name llama2 --spec_alpha1 0.3 --spec_alpha2 0.8 --attacker {} --defender SpeculativeSafeDecoding --GPT_API sk-7a2a9ad8ad06460ea13b61f31d73101f --additional_save_suffix 0dot3_0dot8_new"
...
for attacker in attackers:
    ...
    log_file = f"{attacker}_llama2_speculativeSafeDecoding_alpha_0dot3_0dot8_new.log"
    cmd = base_cmd.format(attacker)
    run_command(cmd, log_file)

print("\nAll GPU 2 experiments completed!") 