...
if args.model_name == "vicuna":
    model_name = "/path/to/your/vicuna_model"
    template_name = 'vicuna'
elif args.model_name == "llama2":
    model_name = "/path/to/your/llama2_7b_chatmodel"
    ...
    model_name = "/path/to/your/llama2-13b-chat_model"
    template_name = 'llama-2'
    ...
    model_name = "/path/to/your/llama3.1_8b_model"
    template_name = 'llama-3'
elif args.model_name == "llama3.2_1b_augmented":
    model_name = "/path/to/your/llama3.2_1b_augmented_model"
    template_name = 'llama-3'
...
model, tokenizer = load_model_and_tokenizer(model_name, 
                       ...
                       device=device)
safe_decoder = None
if args.defender != 'SpeculativeSafeDecoding':
    ...
    if args.is_defense:
        if args.model_name == "llama3.1_8b":
    ...
    if args.spec_using_lora_for_expert == True:
        ...
        if(args.expert_model_name == "TinyLlama-1.1B-Chat-v0.4-augmented"):
            expert_model = PeftModel.from_pretrained(expert_model, "../lora_modules/"+"TinyLlama", adapter_name="expert")
        else:
...
# Load BPE Dropout
    ...
    safe_decoder = SpeculativeSafeDecoding(model, tokenizer, expert_model,expert_tokenizer, alpha1=args.spec_alpha1, alpha2=args.spec_alpha2,top_k=args.top_k, num_common_tokens=args.num_common_tokens, verbose=args.verbose)
...
if args.attacker == "AdvBench":
    ...
    with open(f'../datasets/{args.attacker}.json', 'r', encoding='utf-8') as file:
        attack_prompts = json.load(file)
    USE_RAW_INPUTS = True
...
folder_path = "../exp_outputs/"+f'{args.defender if args.is_defense else "nodefense"}_{args.model_name}_{args.attacker}_{args.num_prompts}{"" if args.top_p is None else f"_top_p{args.top_p}"}_{time_str}{f"_{args.additional_save_suffix}" if args.additional_save_suffix is not None else ""}'
...
for prompt in tqdm(attack_prompts):
    ...
    if args.is_defense:
        ...
        # Baseline Implementations
            ...
            outputs, output_length = safe_decoder.safedecoding_speculative(inputs, expert_inputs=draft_inputs, gen_config=gen_config)
...
save_name = f'{args.defender if args.is_defense else "nodefense"}_{args.model_name}_{args.attacker}_{args.num_prompts}{"" if args.top_p is None else f"_top_p{args.top_p}"}_{time_str}{f"_{args.additional_save_suffix}" if args.additional_save_suffix is not None else ""}'
...
if args.eval_mode:
    ...
    if args.attacker != "Just-Eval" and args.attacker != "gsm8k" and args.attacker != "XSTest":
